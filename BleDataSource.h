...
public:
    ...
    void start() override;
    void stop() override;
    double sampleRate() const override { return 250.0; } // Assuming 250Hz like Real/Sim
...
private:
    ...
    // Usually BLE packets are small, but we use "notify_chunked" in firmware which sends chunks.
    // We need to reassemble if the firmware splits the 44-byte logical packet into MTU-sized physical packets.
    ...
    // UUIDs from ble_support.c (Nordic UART Service)
    const QString SERVICE_UUID = "{6E400001-B5A3-F393-E0A9-E50E24DCCA9E}";
    const QString CHAR_TX_UUID = "{6E400003-B5A3-F393-E0A9-E50E24DCCA9E}"; // Notify
    // const QString CHAR_RX_UUID = "{6E400002-B5A3-F393-E0A9-E50E24DCCA9E}"; // Write
